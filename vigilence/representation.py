...
class QualityReport(object):
    ...
    def scrutinize(self, constraints):
        ...
        @param constraints A vigilence.constraints.ConstraintSet instance.
        @returns A list containing any failed vigilence.representation.Satisfaction instances generated by the constraint application.
        """
        dissatifactions = []
